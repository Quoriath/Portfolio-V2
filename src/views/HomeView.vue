<template>
  <main class="min-h-screen flex flex-col-reverse gap-8 items-center md:flex-row md:gap-16 md:justify-center bg-dark">
    <div class="md:flex-3 md:pl-64">
      <div class="text-center md:text-left">
        <p class="text-blue-300 text-lg fadein-up">Hello, I'm</p>
        <h1 class="text-5xl font-extrabold md:text-15xl text-white fadein-up">Jonatan Firdausi</h1>
      </div>
      <div class="py-2">
      ...
      <p class="text-white text-lg fade-in-from-left">Welcome to My personal website. <span class="wave">👋🏼</span></p>
      <div class="flex justify-center md:justify-start mt-4 fadein-up">
        <a href="https://github.com/Quoriath" target="_blank" class="text-blue-400 hover:text-blue-600 transition">
